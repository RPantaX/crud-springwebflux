package com.webflux.crudspringwebflux.controller;

import com.webflux.crudspringwebflux.documents.Contacto;
import com.webflux.crudspringwebflux.repository.ContactoRepository;
...
public class ContactoController {
    ...
    public Mono<ResponseEntity<Contacto>> actualizarContacto(@RequestBody Contacto contacto, @PathVariable String id){
        return contactoRepository.findById(id)
                .flatMap(contactoActualizado-> { //FLAT MAP SE UTILIZA: es para respuestas.
                    contacto.setId(id);
